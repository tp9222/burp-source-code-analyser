# -*- coding: utf-8 -*-
# ============================================================
#  Burp Suite Extension -- Source Code Security Analyser  (80+ rules)
...
#  Main UI Panel
# ------------------------------------------------------------
class SourceCodeAnalyserTab(JPanel):
    ...
    def _build_ui(self):
        ...
        title = JLabel("  \u26a0  Source Code Analyser")
...
class BurpExtender(IBurpExtender, ITab):
    def registerExtenderCallbacks(self, callbacks):
        ...
        self._tab = SourceCodeAnalyserTab(callbacks)
    ...
    def getTabCaption(self):  return "Source Code Analyser"
